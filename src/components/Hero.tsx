...
export default function Hero({ name }: HeroProps) {
  ...
  return (
    <div className="relative overflow-hidden border-b-8 border-black bg-yellow-400 text-black shadow-[0_12px_0_0_rgba(0,0,0,1)]">
      ...
      <div className="absolute -top-20 -left-20 hidden h-64 w-64 -rotate-12 border-8 border-black bg-red-600 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] lg:block" />
      <div className="absolute right-[-60px] -bottom-24 hidden h-72 w-72 rotate-6 border-8 border-black bg-green-600 opacity-80 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] lg:block" />
        ...
        >
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <Badge variant={"outline"} size={"2xl"}>
                {isLoggedIn
                  ? `🎅 Welkom, ${name}!`
                  : "🎅 Welkom bij lootje.app!"}
              </Badge>
              <h1 className="text-6xl leading-none font-black tracking-tight text-black uppercase drop-shadow-[4px_4px_0_rgba(0,0,0,0.25)] md:text-8xl">
              ...
              <p className="max-w-xl border-l-8 border-black bg-white/80 px-6 py-4 text-lg leading-relaxed font-semibold text-black">
                Organiseer eenvoudig je Sinterkerst of andere feestelijke
                lootjestrekkingen. Voeg deelnemers toe, start een trekking en
                deel een persoonlijke link naar elke deelnemer!
              </p>
            </div>

            <div className="flex flex-wrap gap-4 text-sm font-black uppercase">
              <Badge variant={"outline"} size={"xl"}>
                <TreePine /> Maak onbeperkt groepen
              </Badge>
              <Badge variant={"destructive"} size={"xl"}>
                <GiftIcon /> Deel lootjes via een link
              </Badge>
              <Badge variant={"success"} size={"xl"}>
                <Snowflake /> Geen e-mailadressen of andere poespas!
              </Badge>
            </div>
          </div>
