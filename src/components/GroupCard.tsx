      ...
      >
        ...
        <CardHeader className="relative pb-2">
          <div className="flex flex-wrap items-start justify-between gap-2">
            <CardTitle
              className={`text-3xl leading-tight font-black tracking-tight uppercase ${isDark ? "text-white" : "text-black"}`}
            >
              {group.name}
            </CardTitle>
            {group.isDrawn ? (
        ...
        <CardContent className="relative space-y-4 pt-4">
          <div className="space-y-2">
            <div
              className={`flex items-center gap-3 border-2 border-black px-3 py-2 ${isDark ? "bg-white/10" : "bg-black/5"}`}
            >
              <Users className="h-5 w-5" />
              <span
                className={`text-sm font-black uppercase ${isDark ? "text-white" : "text-black"}`}
              >
