  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-yellow-400 pb-24">
      <div className="pointer-events-none" aria-hidden="true">
        <div className="absolute top-32 -left-24 h-72 w-72 -rotate-12 border-8 border-black bg-red-500 opacity-30" />
        <div className="absolute top-120 -right-20 h-64 w-64 rotate-6 border-8 border-black bg-green-400 opacity-30" />
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 py-16">
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-[minmax(0,2.2fr)_minmax(320px,1fr)]">
          ...
          >
            <ParticipantsList
              className="rounded-md shadow-[14px_14px_0px_0px_rgba(0,0,0,1)]"
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-md border-8 border-black bg-white px-6 py-7 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
            ...
            <AnimatePresence mode="wait">
              {!group.isDrawn ? (
                <motion.div
                  ...
                  className="relative overflow-hidden rounded-md border-8 border-black bg-red-500 px-6 py-8 text-white shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]"
                >
                  ...
                  <div className="relative z-10 space-y-5">
                    ...
                    {drawError ? (
                      <p className="text-xs font-semibold text-yellow-200 uppercase">
                        {drawError}
                      </p>
                    ) : null}
                  </div>
...
function StatusBanner({
  ...
  if (isDrawn) {
    return (
      <div className="flex items-center gap-4 rounded-md border-8 border-black bg-green-300 px-5 py-4 shadow-[10px_10px_0px_0px_rgba(0,0,0,1)]">
        <div className="flex items-center justify-center border-4 border-black bg-white p-2">
          <CheckCircle className="h-6 w-6 text-green-700" />
        </div>
        <p className="text-sm leading-snug font-black text-black uppercase">
  ...
  if (participantCount >= 3) {
    return (
      <div className="flex items-center gap-4 rounded-md border-8 border-black bg-orange-400 px-5 py-4 shadow-[10px_10px_0px_0px_rgba(0,0,0,1)]">
        <div className="flex items-center justify-center border-4 border-black bg-white p-2">
  ...
  return (
    <div className="flex items-center gap-4 rounded-md border-8 border-black bg-red-600 px-5 py-4 text-white shadow-[10px_10px_0px_0px_rgba(0,0,0,1)]">
      <div className="flex items-center justify-center border-4 border-black bg-white p-2 text-red-600">
        <AlertCircle className="h-6 w-6" />
      </div>
      <p className="text-sm leading-snug font-black uppercase">
